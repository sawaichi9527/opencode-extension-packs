...
description: 說明本地 Git、Forgejo Remote 與可選 Forgejo MCP 的分工，協助小型團隊安全 clone、fetch、commit、push 與建立協作流程。當使用者要操作區網 Forgejo 遠端（clone／fetch／pull／push、remote 設定、建立 Repository、Issue／PR／Release）、處理 Token／MCP 權限，或詢問「Forgejo 怎麼設定」時載入。
---

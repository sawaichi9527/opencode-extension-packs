...
- Recorded that only Windows 10 IoT Enterprise LTSC 2021 with no WSL has been verified so far; Ubuntu desktop installation is explicitly pending and must be validated by the team before this pack is treated as cross-platform.
